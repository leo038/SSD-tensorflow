...
def _get_output_filename(output_dir, name, split_name):
    return '%s/%s_%s.tfrecord' % (output_dir, name, split_name)
...
def run(dataset_dir, output_dir, name, shuffling=False):
    ...
    while i < len(filenames):
        ...
        tf_filename = _get_output_filename(output_dir, name, 'test')
